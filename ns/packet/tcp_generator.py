...
class TCPDisPacketGenerator:
    """
    YDY create; Generate packet by a certain distribution
    """
    """Generates packets with a simulated TCP protocol.
    ...
    def __init__(self, env, flow, cc, arrival_dist, size_dist, element_id=None, debug=False):
