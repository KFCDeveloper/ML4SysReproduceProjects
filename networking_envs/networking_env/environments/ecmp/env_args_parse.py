...
def process_args(args):
    ...
    if args.remote:
        ...
        cplex_path = r"PATH" # PATH_TO_CPLEX_REMOTE
        ...
        cplex_path = r"LD_LIBRARY_PATH" #PATH_TO_CPLEX_LOCAL
        gurobi_path = r"LD_LIBRARY_PATH" #  PATH_TO_GUROBI_LOCAL  LD_LIBRARY_PATH
    ...
    graph_path = "%s/data" % base_path # %s/data/
    hist_path = "%s/data" % base_path # %s/data/
