...
label_dic={'CAUSALSIM_DIR-20-7-27/':10,'CAUSALSIM_DIR-20-9-27/':8,'CAUSALSIM_DIR-20-11-27/':6,'CAUSALSIM_DIR-21-1-27/':4,'CAUSALSIM_DIR-21-3-27/':2}
for root_dir in ['CAUSALSIM_DIR-20-7-27/','CAUSALSIM_DIR-20-9-27/','CAUSALSIM_DIR-20-11-27/','CAUSALSIM_DIR-21-1-27/','CAUSALSIM_DIR-21-3-27/']:
    sim_EMDs = []
    labels = []
    ...
    plt.plot(labels, sim_EMDs, label=str(label_dic[root_dir])+' months')    # [i/12*100 for i in range(1, 13)]
plt.legend()
