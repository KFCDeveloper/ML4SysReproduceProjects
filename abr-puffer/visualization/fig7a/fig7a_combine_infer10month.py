...
# python visualization/fig7a/fig7a_combine_infer10month.py --dir CAUSALSIM_DIR-20-7-27/
...
for root_dir in ["CAUSALSIM_DIR-dis-20-7-27/","CAUSALSIM_DIR-dis-20-8-27/","CAUSALSIM_DIR-dis-20-9-27/","CAUSALSIM_DIR-dis-20-10-27/","CAUSALSIM_DIR-dis-20-11-27/","CAUSALSIM_DIR-dis-20-12-27/","CAUSALSIM_DIR-dis-21-1-27/","CAUSALSIM_DIR-dis-21-2-27/"]:
    sim_EMDs = []
    labels = []
    with open(f'{root_dir}tuned_hyperparams/buffer.pkl', 'rb') as f:
        f = pickle.load(f)
...
plt.savefig('/mydata/Unbiased-Trace-Driven-Simulation/abr-puffer/visualization/fig7a/fig_save/fig7a_combine_infer10month.png')