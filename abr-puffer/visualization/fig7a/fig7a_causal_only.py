...
plt.plot(expert_EMDs, [i/4*100 for i in range(1, 5)], label='ExpertSim')
plt.plot(sim_EMDs, [i/4*100 for i in range(1, 5)], label='CausalSim')
plt.legend()
plt.ylabel('CDF %')
plt.xlabel('EMD')
...
plt.savefig(f'{fig_path}/fig7a.png')