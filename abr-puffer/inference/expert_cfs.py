...
for today in tqdm(all_days):
    ...
    np.save(f'{new_path}/{date_string}_linear_bba_buffs.npy', np.array(bba_buffs,dtype=object))
    np.save(f'{new_path}/{date_string}_bola1_buffs.npy', np.array(bola1_buffs,dtype=object))
    np.save(f'{new_path}/{date_string}_bola2_buffs.npy', np.array(bola2_buffs,dtype=object))
    np.save(f'{new_path}/{date_string}_linear_bba_actions.npy', np.array(bba_sizes,dtype=object))
    np.save(f'{new_path}/{date_string}_bola1_actions.npy', np.array(bola1_sizes,dtype=object))
    np.save(f'{new_path}/{date_string}_bola2_actions.npy', np.array(bola2_sizes,dtype=object))
    np.save(f'{new_path}/{date_string}_linear_bba_ssims.npy', np.array(bba_ssims,dtype=object))
    np.save(f'{new_path}/{date_string}_bola1_ssims.npy', np.array(bola1_ssims,dtype=object))
    np.save(f'{new_path}/{date_string}_bola2_ssims.npy', np.array(bola2_ssims,dtype=object))
    np.save(f'{new_path}/{date_string}_linear_bba_rebuffs.npy', np.array(bba_rebufs,dtype=object))
    np.save(f'{new_path}/{date_string}_bola1_rebuffs.npy', np.array(bola1_rebufs,dtype=object))
    np.save(f'{new_path}/{date_string}_bola2_rebuffs.npy', np.array(bola2_rebufs,dtype=object))
    np.save(f'{new_path}/{date_string}_linear_bba_dts.npy', np.array(bba_download_times,dtype=object))
    np.save(f'{new_path}/{date_string}_bola1_dts.npy', np.array(bola1_download_times,dtype=object))
    np.save(f'{new_path}/{date_string}_bola2_dts.npy', np.array(bola2_download_times,dtype=object))
