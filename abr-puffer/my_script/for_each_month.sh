...
c_s=("0.05" "0.1" "0.5" "1.0" "5.0" "10.0" "15.0" "20.0" "25.0" "30.0" "40.0")  # "0.05" "0.1" "0.5" "1.0" "5.0" "10.0" "15.0" "20.0" "25.0" "30.0" "40.0";  "0.1" "0.5" 
...
do  
    ...
    # tmux send-keys -t "$session_name" "/mydata/miniconda3/envs/casual_sim_abr/bin/python analysis/tune_buffer_hyperparam_no_sl.py --dir $root_dir" C-m

    # Tune CausalSim's hyper-parameters for downloadtime prediction
    tmux send-keys -t "$session_name" "/mydata/miniconda3/envs/casual_sim_abr/bin/python analysis/tune_downloadtime_hyperparams.py --dir $root_dir" C-m
done