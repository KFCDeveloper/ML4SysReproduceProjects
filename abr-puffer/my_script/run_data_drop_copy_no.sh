...
do  
    ...
    do
        # 定义 tmux 会话名称
        session_name="${target}_${root_dir}"
        ...
        do  
            ...
            tmux send-keys -t "$session_name" "/mydata/miniconda3/envs/casual_sim_abr/bin/python analysis/tune_buffer_hyperparams.py --dir $root_dir" C-m
